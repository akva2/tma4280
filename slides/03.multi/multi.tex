...
\begin{center}
\includegraphics[width=7.5cm]{multiprocess1}
\end{center}
\end{frame}

\begin{frame}\frametitle{Multi-processor systems: distributed memory access}
\begin{center}
\includegraphics[width=7.5cm]{multiprocess2}
\end{center}
\end{frame}
...
\vspace{.2cm}
\begin{center}
\includegraphics[width=7.5cm]{crossbar}
\end{center}
...
\vspace{.3cm}
\begin{center}
\includegraphics[width=8.5cm]{ccNUMA}
\end{center}
...
\vspace{.2cm}
\begin{center}
\includegraphics[width=8.5cm]{MIMD}
\end{center} 
\end{frame}
...
\begin{center}
\begin{tabular}{lr}
\includegraphics[width=3.5cm]{2Dmesh} \hspace{1.5cm}& \hspace{1.5cm}
\includegraphics[width=4.cm]{2Dtoroid}
\end{tabular}
\end{center} 
