...
\begin{center}
\includegraphics[width=7.5cm]{../../notes/02.multi/multiprocess1}
\end{center}
\end{frame}

\begin{frame}\frametitle{Multi-processor systems: distributed memory access}
\begin{center}
\includegraphics[width=7.5cm]{../../notes/02.multi/multiprocess2}
\end{center}
\end{frame}
...
\vspace{.2cm}
\begin{center}
\includegraphics[width=7.5cm]{../../notes/02.multi/crossbar}
\end{center}
...
\vspace{.3cm}
\begin{center}
\includegraphics[width=8.5cm]{../../notes/02.multi/ccNUMA}
\end{center}
...
\vspace{.2cm}
\begin{center}
\includegraphics[width=8.5cm]{../../notes/02.multi/MIMD}
\end{center} 
\end{frame}
...
\begin{center}
\begin{tabular}{lr}
\includegraphics[width=3.5cm]{../../notes/02.multi/2Dmesh} \hspace{1.5cm}& \hspace{1.5cm}
\includegraphics[width=4.cm]{../../notes/02.multi/2Dtoroid}
\end{tabular}
\end{center} 
